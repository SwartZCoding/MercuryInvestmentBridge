...
import fr.mercury.investbridge.utils.Materials;
import fr.mercury.investbridge.utils.ReflectionUtils;
...
public class SkullUtils {
    ...
    private static final boolean SUPPORTS_UUID = true;
    ...
    public static ItemStack getSkull(@Nonnull UUID id) {
        ...
        ItemStack head = new ItemStack(Materials.PLAYER_HEAD.toBukkitType(), 1, (short) 3);
